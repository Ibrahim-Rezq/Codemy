        ...
        <div>
                ...
                <div className="flex-none mr-8">
                        ...
                        >
                            <div className="card-body">
                                ...
                                <div className="mt-4 border-t border-zinc-200 flex justify-between py-2	mb-0">
                                    <a href="#" className="hover:text-blue-700 font-bold mt-4 ml-2">
                                        Mark all as read
                                    </a>
                                    <a href="#" className="hover:text-blue-700 btn btn-outline mt-2 rounded">
                                        See all
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="dropdown dropdown-end ml-3">
                        ...
                        >
                            ...
                            <li className="border-b border-grey-600">
                                <a href="#" className="hover:text-blue-700 mt-2">
                                    My learning
                                </a>
                                <a href="#" className="hover:text-blue-700 mt-2">
                                    My cart
            ...
            <div className="navbar bg-base-100 shadow">
                <div className="flex-1 container ml-12 ">
                    <div>
                        <a href="#" className="hover:text-blue-700 mr-5">
                            Developement
                        </a>
                    </div>
                    <div>
