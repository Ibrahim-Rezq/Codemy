        ...
        <div className="navbar bg-base-100 border-b border-gray-300">
                            ...
                            <div className="card-body mt-4 ">
                                {/* product 1*/ }
                                   <div className="mb-3">
                                        <div className="flex mb-3">
                                                        ...
                                                        <div className='ml-3'>
                                                            <h3 className='font-bold text-base'><a href='#'>Lorem, ipsum dolor sit amet consectetur </a></h3>
                                                            <p className='text-gray-400 my-1'>Robin jesper</p >
                                                            <p> <span className='text-sm font-bold'>$ 9.00</span> <span className='pl-1 line-through text-gray-500'>$ 10.00</span></p>
                                                        </div>
                                        </div>
                               ...
                               {/* actions */}
                                ...
                                <div className="border-t ">
                                      <button className='btn btn-dark rounded w-full mt-4'>
                                            Go to wishlist
                                        </button>
                                </div>
                        ...
                        <div tabIndex="0" className="mt-3  card card-compact  dropdown-content w-52 bg-base-100 shadow border border-grey-400 w-96 rounded">
                            <div className="card-body mt-4 ">
                               ...
                               {/* actions */}
                                ...
                                <div className="border-t ">
                                    <p className='mt-4'><span className='font-bold text-xl'>Total : 9.00 $</span> <span className='pl-1 line-through text-gray-500'>$ 10.00</span></p>
                                </div>
                        ...
                        <div tabIndex="0" className="mt-3 card card-compact  dropdown-content w-52 bg-base-100 shadow border border-grey-400 w-96 rounded">
                            <div className="card-body">
                              ...
                              <div className="flex text-lg">
                                ...
                                <h2 className="ml-auto font-bold text-primary"><a href="">Settings</a></h2>
                              </div>
                                {/* notifications */}
                             <div className=' mt-5'>
                                {/* notification 1 */}
                             ...
                             <div className="mt-4 border-t border-zinc-200 flex justify-between py-2	mb-0">
                                <a href="#" className='font-bold mt-4 ml-2'>Mark all as read</a>
                                <a href="#" className='btn btn-outline mt-2 rounded'>See all</a>
                    ...
                    {/* profile actions */}
                     <div className="dropdown dropdown-end ml-3">
                        ...
                        <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 border border-grey-400 w-72">
                            ...
                            <li className='border-b border-grey-600'>
                                <a href='#' className='mt-2'>My learning</a>
                                <a href='#' className='mt-2'>My cart</a>
                                <a href='#' className='mt-2'>Wishlist</a>

                            </li>
                            <li className='border-b border-grey-600'>
                                <a href='#' className='mt-2'>Notification</a>
                                <a href='#' className='mt-2'>Messages</a>
                            </li>
                            <li className='border-b border-grey-600'>
                                <a href='#' className='mt-2'>Account settings</a>
                                <a href='#' className='mt-2'>Purchase history</a>
                            </li>
                            <li className='border-b border-grey-600'>
                           
                                <a href='#' className='mt-2'>Edit Profile</a>
                            </li>
                            <li >
                                <a href='#' className='mt-2'>Logout</a>
                            </li>
                        </ul>
                      </div>
                 </div>
            ...
            <div className="navbar bg-base-100 shadow">
                <div className="flex-1 container ml-12 ">
                    ...
                    <div>
                        <a href="#" className='mr-5'>Health</a>
                    </div>
                    <div>
                        <a href="#" className='mr-5'>Finance</a>
                    </div>
                    <div>
                        <a href="#" className='mr-5'>Office productivity</a>
                    </div>
                    <div>
                        <a href="#" className='mr-5'>Personal developement</a>
                    </div>
                </div>
            </div>
